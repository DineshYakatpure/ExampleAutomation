...
public class ChromeBrowserTest4{
	...
	static void createCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("dinesh");
	...
	static void modifyCustomer()
	{
		try
		{
			...
			oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[2]/div[1]/div[3]/div/div[2]/input")).sendKeys("-NEW");
			Thread.sleep(2000);	
