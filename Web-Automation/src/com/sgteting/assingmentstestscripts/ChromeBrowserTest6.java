package com.sgteting.assingmentstestscripts;
import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;
import org.openqa.selenium.chrome.ChromeDriver;

//ASSIGNMENT - 6). lanchBrowser --> navigate --> login --> createCustomer --> createProject --> modifyProject --> deleteProject --> deleteCustomer --> logout --> closeApplication


public class ChromeBrowserTest6 {
	...
	static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(4000);
			getbrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[1]"));
			Thread.sleep(4000);
			getbrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("-extended");
			Thread.sleep(2000);
			getbrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[1]/div[1]")).click();Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
